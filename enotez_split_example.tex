...
\section{Test}
Text\endnote{\kant[1]}. Text\endnote{\kant[2]}. Text\endnote{This time with a
  \textbf{nested}\endnote{\kant[3]}\endnote{\kant[4]} endnote.}.
...
\begin{figure}[htp]
  \centering
  \includegraphics[width=.4\linewidth]{example-image-a}
  \caption[caption]{Some text\endnote{An endnote with a nested
      endnote\endnote{\kant[7]} inside a figure caption.}.}
\end{figure}

\section{Test}
Text\endnote{\kant[8]}. Text\endnote{\kant[9]}. Text\endnote{This time with a
  \textbf{nested}\endnote{\kant[10]} endnote.}. Text\endnote{\kant[11]}.
